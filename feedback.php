		...
		<div class="main-header row">
		  ...
		  <div class="col-sm-6 col-xs-5 height-header1">
			...
			<ul class="user-info pull-left">          
			  ...
			  <a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false"> <img width="44" class="img-circle avatar" alt="" src="images/nu.jpg">Tina Pham <span class="caret"></span></a>
